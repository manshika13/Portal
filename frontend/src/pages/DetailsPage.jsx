...
const DetailsPage = () => {
  ...
  return (
    <div className="container mt-5">
      ...
      <form onSubmit={handleSubmit} className="p-4 bg-white shadow-lg rounded-4">
        {/* Name */}
        <div className="mb-3">
          <label className="form-label fw-semibold">Full Name (as per Document ID)</label>
        ...
        <div className="mb-3">
          ...
          <input type="text" name="documentId" className="form-control" onChange={handleChange} required />
        </div>
        ...
        {correctionType === "Address" && (
          <>
            <div className="mb-3">
              ...
              <input type="text" name="addressLine1" className="form-control" onChange={handleChange} required />
            </div>
            <div className="mb-3">
            ...
            <div className="mb-3">
              ...
              <input type="text" name="pincode" className="form-control" maxLength="6" pattern="[0-9]{6}" onChange={handleChange} required />
            </div>
          </>
        )}
        ...
        {(correctionType === "Photo" || correctionType === "Signature") && (
          <div className="mb-3">
            <label className="form-label fw-semibold">Upload {correctionType}</label>
        ...
        <div className="mb-3">
          ...
          <textarea name="reason" className="form-control" onChange={handleChange} required></textarea>
        </div>
